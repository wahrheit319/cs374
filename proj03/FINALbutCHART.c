...
int main(int argc, char **argv)
{
    ...
    if (id == 0)
    {
        FILE *file = fopen("output.csv", "w"); // Open a file in write mode
        if (file == NULL)
        {
        ...
        // Write header to both the file and the terminal
        fprintf(file, "Probability,Average Percent Burned,Average Iterations\n");
